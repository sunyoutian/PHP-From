...
<body>
  ...
  <p>
    What do you read?
    <br><label><input name="publication[]" type="checkbox" id="publication_drf" value="BuzzFeed"> BuzzFeed </label>
    <br><label><input name="publication[]" type="checkbox" id="publication_elle" value="Reddit"> Reddit </label>
  </p>
  <p>
    Fun Stuff: <br>
